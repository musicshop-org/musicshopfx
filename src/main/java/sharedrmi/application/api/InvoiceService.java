...
public interface InvoiceService extends Remote {
    InvoiceDTO findInvoiceById(InvoiceId var1) throws RemoteException, Exception;

    void createInvoice(InvoiceDTO var1) throws RemoteException;

    void returnInvoiceLineItem(InvoiceId var1, InvoiceLineItemDTO var2, int var3) throws RemoteException, Exception;
}